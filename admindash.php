	...
	<div class="container-fluid">
		...
		<div class="col-xl-2 col-lg-3 col-md-4 sidebar fixed-top">
			...
			<ul class="navbar-nav flex-column mt-4">
					   <li class="nav-item"><a href="admindash.php" class="nav-link text-white p-3 mb-2 current"><i class="fas fa-home text-light fa-lg mr-3"></i>Dashboard</a></li>
				  
				   <li class="nav-item"><a href="halladmindash.php" class="nav-link text-white p-3 mb-2 sidebar-link"><i class="fas fa-envelope text-light fa-lg mr-3"></i>Hall</a></li>
				 <li class="nav-item"><a href="customer.php" class="nav-link text-white p-3 mb-2 sidebar-link"><i class="fas fa-envelope text-light fa-lg mr-3"></i>Customer</a></li>
					 ...
					 session_start();
{
 $con=mysqli_connect('localhost','root','','project') or die(mysqli_error());
			  ...
			  $query=mysqli_query($con,"select * from customer where hall <>'no'") or die(mysqli_error($con));
...
?>
 	...
 	<form action="#" method="post">
          ...
          <button type="btn" name="sub" class="btn btn-primary btn-lg btn-block loader-button">LOG OUT</button>
