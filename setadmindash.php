		...
		<div class="col-xl-2 col-lg-3 col-md-4 sidebar fixed-top">
			...
			<ul class="navbar-nav flex-column mt-4">
				...
				<li class="nav-item"><a href="inboxadmindash.php" class="nav-link text-white p-3 mb-2 "><i class="fas fa-envelope text-light fa-lg mr-3"></i>Inbox</a></li>
				   <li class="nav-item"><a href="setadmindash.php" class="nav-link text-white p-3 mb-2 current"><i class="fas fa-wrench text-light fa-lg mr-3"></i>Settings</a></li>
...
function changepass($con)
{
	...
	{
	$query = mysqli_query($con,"UPDATE admin SET password= '".$pass1."' where password= '".$pass."'") or die(mysqli_error($con));	
